...
export default function FeaturedWork() {
  ...
  // Mobile: single-column carousel with swipe + arrows + dots
    ...
    <section style={{ padding: '60px 16px', backgroundColor: '#0A0A0A' }}>
      <div style={{ maxWidth: '400px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{ color: '#B0B0B0', fontSize: '14px' }}>Swipe or tap arrows to browse</p>
        </div>

        {/* Carousel */}
        <div
          style={{ position: 'relative', borderRadius: '8px', overflow: 'hidden', touchAction: 'pan-y' }}
        ...
        >
          ...
          {/* Arrow buttons */}
          <button onClick={prevSlide} style={{ position: 'absolute', left: '8px', top: '40%', transform: 'translateY(-50%)', background: 'rgba(10,10,10,0.7)', border: '1px solid #C8A97E', color: '#C8A97E', width: '36px', height: '36px', borderRadius: '50%', cursor: 'pointer', fontSize: '18px', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 2 }}>‹</button>
          <button onClick={nextSlide} style={{ position: 'absolute', right: '8px', top: '40%', transform: 'translateY(-50%)', background: 'rgba(10,10,10,0.7)', border: '1px solid #C8A97E', color: '#C8A97E', width: '36px', height: '36px', borderRadius: '50%', cursor: 'pointer', fontSize: '18px', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 2 }}>›</button>
        </div>
