  ...
  return (
    <div style={{ width: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', width: '100%', height: '50vh', minHeight: '280px', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', bottom: '24px', left: '16px', right: '16px', maxWidth: '100%' }}>
          ...
          <h1 style={{ fontFamily: 'Bebas Neue, sans-serif', fontSize: '42px', color: '#FFFFFF', letterSpacing: '4px', lineHeight: '1', marginBottom: '6px' }}>ANBU TATTOO</h1>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <Link href="/booking" style={{ color: '#0A0A0A', backgroundColor: '#C8A97E', padding: '12px 16px', borderRadius: '4px', textDecoration: 'none', fontSize: '12px', fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', flex: 1, textAlign: 'center' }}>Book Now</Link>
            <Link href="/portfolio" style={{ color: '#C8A97E', padding: '12px 16px', borderRadius: '4px', textDecoration: 'none', fontSize: '12px', fontWeight: 600, letterSpacing: '1px', textTransform: 'uppercase', border: '1px solid #C8A97E', flex: 1, textAlign: 'center' }}>Portfolio</Link>
          </div>
        </div>
      </div>

      {/* Thumbnail strip */}
      <div style={{ display: 'flex', gap: '8px', padding: '12px 16px', overflowX: 'auto', width: '100%' }}>
